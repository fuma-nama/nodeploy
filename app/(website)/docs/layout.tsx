    ...
    return (
        <SidebarProvider>
            <div className="flex flex-col px-8 sm:px-14 xl:px-24">
                <div className="grid grid-cols-1 lg:grid-cols-[250px_auto] xl:grid-cols-[300px_auto_150px] 2xl:grid-cols-[300px_auto_300px] gap-12 mx-auto w-full max-w-screen-2xl min-h-screen">
