    ...
    <>
      ...
      >
        <div className="flex flex-col md:flex-row gap-6 max-w-screen-lg w-full mx-auto">
          <Image alt="image" src={"./train.svg"} width={242} height={55} />
          <div>
            <h2 className="text-xl font-semibold">DevOps is no longer a Job</h2>
  ...
  return (
    <div className="p-8 sm:px-14 xl:px-24 text-center flex flex-col items-center gap-3 mt-40 overflow-hidden">
      ...
      <p className="text-muted-foreground text-lg max-w-xl">
        All features, frameworks and programming languages that run in your mind
      ...
      <div className="w-full max-w-screen-lg grid grid-cols-1 md:grid-cols-2 mt-16 text-start gap-x-6 gap-y-14">
        ...
        <div className="flex flex-col gap-3 max-md:text-center max-md:items-center md:border-[1px] md:p-8 md:rounded-lg">
          ...
          <p className="text-muted-foreground">
            Preventing you to use Docker because we handle none of them
          </p>
        </div>
      </div>
    </div>
...
function Promotion() {
  return (
    <div className="p-8 sm:px-14 xl:px-24 text-center flex flex-col items-center gap-3 relative mt-20">
      ...
      <p className="text-muted-foreground text-lg max-w-xl">
        Ignore your team members and skip code previews, start promoting your
        project on Reddit
      </p>
      ...
      <div className="w-full max-w-screen-lg grid grid-cols-1 md:grid-cols-2 mt-16 text-start gap-10">
        <div className="flex flex-col relative">
          <div className="flex flex-col divide-y-2 divide-border bg-secondary rounded-xl mr-10">
            {comments.map((comment, i) => (
              <div key={i} className="p-5 flex flex-row gap-3 items-start">
                <Image
                  alt="avatar"
                  src={comment.avatar}
                  width={40}
        ...
        <div className="flex flex-col gap-3 max-md:text-center max-md:items-center">
          ...
          <p className="text-muted-foreground max-w-xl">
            Stop wasting time on previewing code, just ignore all the bugs and
            design patterns
          </p>
          ...
          <p className="text-muted-foreground max-w-xl">
            Skip painful communications between team members and developers,
            just focus on destroying your project
          </p>
          ...
          <h3 className="text-xl font-semibold">No Limits for Promotion</h3>
          <p className="text-muted-foreground max-w-xl">
            Promote your project to the world and never worry about breaking
            subreddit rules, since you have deployed nothing
          </p>
        </div>
      </div>
    </div>
  ...
  return (
    <>
      <div className="p-8 sm:px-14 xl:px-24 text-center flex flex-col items-center gap-3">
        ...
        <p className="text-muted-foreground text-lg max-w-xl">
          Stop working on annoying things, unnecessury things that slow you
          down, just imagine how your app works in your brain
        </p>
        <div className="w-full max-w-screen-lg grid grid-cols-1 md:grid-cols-2 mt-16 text-start gap-10">
          <div className="flex flex-col">
            <div className="rounded-2xl border-2 border-border shadow-xl shadow-purple-600/50 flex flex-col mr-10">
              ...
              <code className="p-4 pb-20">
                sudo rm -rf /* <span className="animate-pulse">|</span>
              </code>
            </div>
          ...
          <div className="flex flex-col gap-3 max-md:text-center max-md:items-center">
            ...
            <h3 className="text-xl font-semibold">100% Faster Performance</h3>
            <p className="text-muted-foreground max-w-xl">
              Free developers from time-consuming jobs, your job is no longer
              exists so that you can spend your time on something meaningful
            </p>
            ...
            <h3 className="text-xl font-semibold">No Move and Break Nothing</h3>
            <p className="text-muted-foreground max-w-xl">
              Codebase doesn't exist, no more breaking changes will be made to
              your codebase
            </p>
          </div>
        </div>
      ...
      <div className="p-8 sm:px-14 xl:px-24 flex flex-col items-center text-center gap-3 bg-gradient-to-b from-transparent to-purple-400/40 min-h-[300px] mt-20">
        ...
        <p className="text-muted-foreground drop-shadow-xl">
          Connect to your project, database and integrated services, from any
          terminal
        </p>
        <input
          readOnly
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full max-w-4xl mt-3 gap-3">
          <div className="rounded-lg bg-background text-foreground p-3">
            <h3 className="font-semibold">Integrate with Nothing</h3>
  ...
  return (
    <>
      <div className="p-8 sm:px-14 xl:px-24 text-center flex flex-col items-center gap-3 mt-20 overflow-hidden">
        ...
        <h2 className="text-orange-400 text-3xl md:text-4xl font-bold">Ship</h2>
        <h2 className="text-4xl md:text-5xl text-foreground font-bold text-center">
          <span className="whitespace-nowrap">Deploy to the Edge</span>
        </h2>
        <p className="text-muted-foreground text-lg max-w-xl">
          ...
          with the fastest speed, by not deploying your app to any servers
        </p>
        ...
        <div className="w-full max-w-screen-wide grid grid-cols-1 md:grid-cols-2 mt-16 text-start z-[2] relative">
          ...
          >
            <h3 className="text-2xl font-semibold">
              We focus on <u className="decoration-orange-400">Performance</u>,{" "}
              <u className="decoration-orange-400">Speed</u> and{" "}
              <u className="decoration-orange-400">User Experience</u>
            </h3>
            <p className="text-muted-foreground">
              Built with the cutting-edge serverless technology, we provide
              extremely scalable, safe and reliable service that handles the
              millions in 0ms
            </p>
            ...
            <h3 className="text-xl font-semibold">Global Neural Network</h3>
            <p className="text-muted-foreground max-w-xl">
              Access your website from anywhere with the fastest speed in the
              world, getting a not found page within 0 second
            </p>
            ...
            <p className="text-muted-foreground max-w-xl">
              Monitor your site without opening your computer, easily view
              analyst, traffic and usages right in your mind
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col">
      ...
      <p className="text-lg mt-4 text-muted-foreground max-w-xl">
        Built for Developers, No Deploy is the Most Powerful and Scalable
        Hosting platform that supports Nothing
      </p>
